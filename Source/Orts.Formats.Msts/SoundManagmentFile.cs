...
namespace Orts.Formats.Msts
{
    ...
    {
        public enum Controls { None, DistanceControlled, SpeedControlled, Variable1Controlled, Variable2Controlled, Variable3Controlled, Variable4Controlled, Variable5Controlled, BrakeCylControlled, CurveForceControlled };
    ...
    public class Variable_Trigger : Trigger
    {
        ...
        Variable1_Inc_Past, Variable1_Dec_Past, Variable2_Inc_Past, Variable2_Dec_Past, Variable3_Inc_Past, Variable3_Dec_Past, Variable4_Inc_Past, Variable4_Dec_Past, Variable5_Inc_Past, Variable5_Dec_Past, BrakeCyl_Inc_Past, BrakeCyl_Dec_Past, CurveForce_Inc_Past, CurveForce_Dec_Past
        };
