...
using Orts.Viewer3D.SharedMemoryFiles;

namespace Orts.Viewer3D.Processes
{
    public class SharedMemoryProcess
    {
        public readonly Profiler Profiler = new Profiler("SharedMemory");
        readonly ProcessState State = new ProcessState("SharedMemory");
        readonly Game Game;
        ...
        public SharedMemoryProcess(Game game)
        {
            Game = game;

            Thread = new Thread(SharedMemoryThread);
            ThreadActive = true;
        }
